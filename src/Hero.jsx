    ...
    return(
        <div className="flex flex-col sticky items-center top-10 md:top-15 lg:top-25 ">
            ...
            <div className="md:self-start md:mt-15 mt-5 flex items-center gap-5">
                ...
                <a className="hover:bg-blue-500 transition-bg duration-250 flex itmes-center gap-3 ring-1 p-2 pt-3 pb-3 rounded-lg ring-blue-500" href="/CV.pdf" download="CV.pdf" target="_blank">Download CV </a>
            </div>
        </div>
    )
}
